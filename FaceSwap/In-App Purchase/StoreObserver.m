...
- (void)paymentQueue:(SKPaymentQueue *)queue removedTransactions:(NSArray *)transactions
{
    for(SKPaymentTransaction * transaction in transactions)
    {
        ...
        self.message = @"Transcation canceled.";
//        InAppPurchaseView *myxibView = [[[NSBundle mainBundle] loadNibNamed:@"InappPurchaseIpad" owner:self options:nil] objectAtIndex:0];
